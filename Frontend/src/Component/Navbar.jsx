...
function Navbar() {
  ...
  return (
    <>
    <div className={`max-w-scree-2x1 container mr-auto mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointrt">Book<span className='text-pink-500'>store</span></a>
  </div>
